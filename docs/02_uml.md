...
sequenceDiagram
    ...
    Pay->>Pay: Заблокировать (холд) 320,000 ₽ на балансе Покупателя (Канонический статус: hold / UI: "оплачена")
    ...
    Note over Seller, Buyer: Продавец отправляет товар курьером (Канонический статус: shipped / UI: "отправлена")
    ...
    Note over Buyer: Покупатель осматривает товар при получении (Канонический статус: completed / UI: "завершена")
